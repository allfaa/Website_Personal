...
<body>
    <div align="center"><strong>
            <font size="6" face="Courier New, Courier, mono">Silahkan Formulir untuk Pemesanan</font>
        </strong></div>
    <form name="form1" method="post" action="proses.php">
        <table class="formulir" width="58%" border="0" align="center">
            <tr>
                <td>Nama Lengkap</td>
